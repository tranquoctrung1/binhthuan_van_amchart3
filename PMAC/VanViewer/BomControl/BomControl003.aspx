<%@ Page Language="C#" MasterPageFile="../MasterPage.master" AutoEventWireup="true" CodeFile="BomControl003.aspx.cs" Inherits="VanViewer_BomControl_BomControl003" %>
                                ...
                                <div class="col-md-8 col-bom-control" data-aos="fade-down">
                                    <div class="row button-bom-control">
                                     ...
                                     <div class="name-station-area">
                                        <h4 class="name-station">Tên Trạm: <span data-toggle="modal1" data-target="#dataViewer" id="showPopupDataViewer">V003</span></h4>
