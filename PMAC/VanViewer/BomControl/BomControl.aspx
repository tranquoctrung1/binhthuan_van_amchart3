<%@ Page Language="C#" MasterPageFile="../MasterPage.master" AutoEventWireup="true" CodeFile="BomControl.aspx.cs" Inherits="VanViewer_BomControl_BomControl" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="container-fluid">
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-bom-control" data-aos="flip-right">
                                    <div class="row button-bom-control">
                                            <button type="button" class="btn btn-info" id="showModal" data-toggle="modal" data-target="#controllerMode" disabled="disabled">Chế Độ Điều Khiển</button>
                                    ...
                                    <div class="name-station-area">
                                        <h4 class="name-station">Tên Trạm: <span data-toggle="modal1" data-target="#dataViewer" id="showPopupDataViewer">V001</span></h4>
                        ...
                        <div class="modal fade" id="dataViewer" tabindex="-1" aria-labelledby="dataViewer" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                <h5 class="modal-title" id="dataViwerTitle">Tên trạm: V001</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                </div>
    ...
    <script src="../../js/BomControl/bomcontroller.js"></script>
    <script src="../../js/BomControl/BomViewer.js"></script>
</asp:Content>
