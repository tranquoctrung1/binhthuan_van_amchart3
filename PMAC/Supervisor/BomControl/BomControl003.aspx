<%@ Page Language="C#" MasterPageFile="../MasterPage.master" AutoEventWireup="true" CodeFile="BomControl003.aspx.cs" Inherits="Supervisor_BomControl_BomControl003" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <section class="bom">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-4 text-center col-table-status" data-aos="fade-right">
                                ...
                                <div class="col-md-8 col-bom-control" data-aos="fade-down">
                                    <div class="row button-bom-control">
                                     ...
                                     <div class="name-station-area">
                                        <h4 class="name-station">Tên Trạm: <span data-toggle="modal" data-target="#dataViewer" id="showPopupDataViewer">V003</span></h4>
                        ...
                        <div class="modal fade" id="dataViewer" tabindex="-1" aria-labelledby="dataViewer" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                <h5 class="modal-title" id="dataViwerTitle">Tên trạm: V003</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                </div>
                        ...
                        <div class="col-md-3 text-center col-table-data" data-aos="fade-left">
                            <table class="table table-data">
                                <thead class="thead">
                                    <tr>
    ...
    <script src="../../js/BomControl/bomcontroller0003.js"></script>
    <script src="../../js/BomControl/BomViewer3.js"></script>
</asp:Content>
