<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="../MasterPage.master" CodeFile="BomControl005.aspx.cs" Inherits="Supervisor_BomControl_BomControl005" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="container-fluid">
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-bom-control" data-aos="flip-right">
                                    ...
                                    <div class="row name-station-area">
                                        <h4 class="name-station">Tên Trạm: <span data-toggle="modal" data-target="#dataViewer" id="showPopupDataViewer">V005</span></h4>
                        ...
                        <div class="modal fade" id="dataViewer" tabindex="-1" aria-labelledby="dataViewer" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                <h5 class="modal-title" id="dataViwerTitle">Tên trạm: V005</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                                </div>
    ...
    <script src="../../js/BomControl/bomcontroller0005.js"></script>
    <script src="../../js/BomControl/BomViewer5.js"></script>
</asp:Content>
