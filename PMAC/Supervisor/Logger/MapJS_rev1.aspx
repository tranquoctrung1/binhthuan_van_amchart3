...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <head>
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA_g_l8px0DA5AV-ul2l1OvblcsagazbhU&callback=initMap"></script>
                                    ...
                                    <ul class="sidebar-nav">
                                        <li>
                                            <a href="/Supervisor/BomControl/BomControl.aspx">
                                                <asp:Label ID="Label2" runat="server" Text="DN200 Gần biển"></asp:Label>    
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/Supervisor/BomControl/BomControl002.aspx">
                                                <asp:Label ID="Label3" runat="server" Text="DN200 QL1"></asp:Label>    
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/Supervisor/BomControl/BomControl003.aspx">
                                                <asp:Label ID="Label4" runat="server" Text="DN150"></asp:Label>    
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/Supervisor/BomControl/BomControl004.aspx">
                                                <asp:Label ID="Label5" runat="server" Text="DN200 Novaworld 1"></asp:Label>    
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/Supervisor/BomControl/BomControl005.aspx">
                                                <asp:Label ID="Label6" runat="server" Text="DN200 Novaworld 2"></asp:Label>    
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/Supervisor/BomControl/BomControl006.aspx">
                                                <asp:Label ID="Label7" runat="server" Text="Van V006"></asp:Label>    
                                            </a>
                                        </li>
                                    </ul>
                                </li>         
